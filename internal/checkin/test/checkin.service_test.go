...
func (t *CheckInServiceTest) TestCreateCheckInSuccess() {
	...
	svc := checkin.NewService(client, t.logger)
	...
	actual, err := svc.Create(t.createCheckInDtoRequest)
...
func (t *CheckInServiceTest) TestFindByUserIdCheckInSuccess() {
	...
	actual, err := svc.FindByUserID(t.findByUserIdCheckInDtoRequest)
...
func (t *CheckInServiceTest) TestFindByEmailCheckInSuccess() {
	...
	actual, err := svc.FindByEmail(t.findByEmailCheckInDtoRequest)
